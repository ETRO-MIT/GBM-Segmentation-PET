        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                for val_data in val_loader:
                    ...
                    df.to_csv(os.path.join(results_root, f'results_UNetMulti_{fold}.csv'))
                ...
                if metric > best_metric:
                    ...
                    torch.save(
                        model.state_dict(),
                        os.path.join(model_root, f"UNetMulti_best_{fold}.pth"),
                    )
                ...
                torch.save(
                    model.state_dict(),
                    os.path.join(model_root, f"UNetMulti_latest_{fold}.pth"),
                )
